...
export default function FormCheckbox({
  ...
  return (
    <div className={cn("inline-flex items-center", containerModifierClass)}>
      <label
      ...
      <label
        className={cn(
          "mt-px ml-2 font-light text-sm text-gray-700 cursor-pointer select-none",
